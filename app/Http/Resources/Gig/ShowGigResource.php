...
use App\Http\Resources\Pricing\ShowGigPricingResource;
...
class ShowGigResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'pricings' => ShowGigPricingResource::collection($this->whenLoaded('gig_pricing')),
